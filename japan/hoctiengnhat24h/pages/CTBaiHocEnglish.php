...
<div id="main_container">
	...
	<div id="main_content"> 
		...
		<div class="center_content" style="width: 784px">
			...
			?>
			<div class="center_title_bar" style="width:742px; background:url(images/bar_bg_des.gif) no-repeat center;">Bài <?php echo getInfoTopicEngById($IdTopic)->STT ?>: <?php echo getInfoTopicEngById($IdTopic)->Title ?></div>
