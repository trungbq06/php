...
DROP TABLE IF EXISTS `dapandung`;
...
LOCK TABLES `dapandung` WRITE;
/*!40000 ALTER TABLE `dapandung` DISABLE KEYS */;
INSERT INTO `dapandung` VALUES (5,'C',5),(6,'A',6),(9,'C',9),(10,'D',10);
/*!40000 ALTER TABLE `dapandung` ENABLE KEYS */;
UNLOCK TABLES;
