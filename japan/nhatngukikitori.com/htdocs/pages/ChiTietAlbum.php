...
<body id="top">
	...
	<div class="wrapper col4">
	  <div id="container">
		<div id="content">
		<h1>Chi Tiết Album Ảnh</h1>
		<?php
			$id=$_GET['Id'];	
		?>
		<p style="text-align:center; font-weight: bold; color: #900; font-size: 18px;"><?php echo getAlbumById($id)->Title ?></p>
		<div id="noidung">
			<?php echo getAlbumById($id)->Content ?>
		<br />
