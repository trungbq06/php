...
<div class="wrapper col4">
  <div id="container">
    <div id="content">
      <h1>Khóa Học Sơ Cấp KS4 (Từ Bài 31 Đến Bài 40)</h1>
		1. Đối tượng đầu vào :
		<ul>
			<li>Các bạn đã vượt qua  trình độ N5 hay tương đương trình độ N4 có khả năng gia tiếp nghe nói, ngữ pháp, kanji, đọc viết tốt hay đủ khả năng và trình độ khóa ks4 và theo kịp bài.có thể hiểu nội dung giao tiếp hàng ngày khi giao tiếp với người khác.</li>
			<li>Các bạn hoàn thành khóa Ks3.</li>
		</ul>
		2. Đối tượng đầu vào :       
		<ul>
			<li>Nghe, nói được thông tin cần thiết trong cuộc hội thoại biết cách tóm tắt và trả lời nhanh.</li>
			<li>Đọc hiểu cùm từ, câu, đoạn văn dạng cố định dài hơn viết bằng chữ hiragana và chữ katakana, chữ kanji ở mức độ lớn hơn.</li>
			<li>Chữ kanji khoảng (200 chữ), từ vựng khoảng ( 1.350 chữ).</li>
		</ul>
      ...
      <form method="post" action="../controller/RegistrationController.php" name="registration" onsubmit="return checkInput();">
        <table width="200" border="0">
          ...
          <tr>
		  <input type="hidden" name="idkhoahoc" value="4">
            <td>&nbsp;</td>
