...
<script>
function checkInput(){
	if(document.clb.title.value==""){ 
		alert("Mời Bạn Nhập Tiêu Đề!");
		document.clb.title.focus();
		return false;
	}
	if(document.clb.password.value==""){ 
		alert("Mời Bạn Nhập Mật Khẩu!");
		document.clb.password.focus();
		return false;
	}
	return true;
}
...
<body>
	...
	<section class="container">
		<div class="login">
			...
			<form method="post" action="../controller/CLBController.php" name="clb" onsubmit="return checkInput();">
				<p>
