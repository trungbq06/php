...
function checkInput(){
	...
	if(document.album.rootimage.value==""){ 
		alert("Mời Bạn Nhập URL Ảnh!");
		document.album.rootimage.focus();
		return false;
	}
	return true;
}
...
<body>
	...
	<section class="container">
		<div class="login">
			<h1>Thông Tin Tin Tức CLB</h1>
			<form method="post" action="../controller/AlbumController.php" name="album" onsubmit="return checkInput();">
				<p>
					<input type="text" name="title" value=""
						placeholder="Tiêu Đề Ngắn Gọn">
				</p>
				<p>
					<input type="text" name="rootimage" value=""
						placeholder="Link Ảnh Bìa Size(140px-107px)">
				</p>
				<p>
