...
DROP TABLE IF EXISTS `khaigiang`;
...
LOCK TABLES `khaigiang` WRITE;
/*!40000 ALTER TABLE `khaigiang` DISABLE KEYS */;
INSERT INTO `khaigiang` VALUES (6,'12/3','13/4',7),(10,'2/3','3/4',2),(11,'2/3','4/5',6),(12,'1/2','2/3',8);
/*!40000 ALTER TABLE `khaigiang` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2013-12-26 14:44:14
