...
<div id="main_container">
	...
	<div id="main_content"> 
		...
		<div class="center_content" style="width: 784px">
			...
			?>
			<div class="center_title_bar" style="width:742px; background:url(images/bar_bg_des.gif) no-repeat center;"> <?php echo getInfoTopicHAById($IdTopic)->Name ?></div>
			<div class="prod_box_big" style="width:779px;">
			    ...
			    <?php echo getInfoTopicHAById($IdTopic)->Content ?>
				</div>
			</div>
					<?php
					} else {
