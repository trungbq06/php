...
<div id="main_container">
	...
	<div id="main_content"> 
		...
		<div class="center_content">
			<div class="center_title_bar">Viết Nhận Xét</div>		
			...
			?>
              	<div class="contact_form">
                	<div>
					<?php 
					if(isset($_GET['message'])) $mes = $_GET['message'];
						if(isset($mes)) 
							echo $mes;
					?>
					</div>
                	<form action="../controller/CommentsController.php" method="post" id="frmdangky">
                        <div class="form_row">
							<label class="contact"><strong>Nội Dung:</strong></label>
							<textarea rows="5" cols="20" class="validate[required]" name="comment" ></textarea>
                        </div>
                        <div class="form_row" style="margin-left: 121px;">
							<input type="submit" name="commit" id="nhận xét" value="Nhận Xét" />
                        </div>      
                 	</form>
                </div>  
				<?php
