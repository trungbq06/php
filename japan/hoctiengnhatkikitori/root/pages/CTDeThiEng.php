...
<body bgcolor="#c7c7c7">
<div id="full">
  <p align="center"><strong>HỌC ANH NHẬT 24H </strong></p>
  <p align="center"><strong>hoctiengnhat24h.com </strong></p>
  <p align="center"><strong>CHƯƠNG TRÌNH HỌC ANH NHẬT TRỰC TUYẾN</strong></p>
    <?php
	if((isset($_SESSION['loginAcc'])) and (isset($_SESSION['id']))){
			if($_SESSION['loginAcc'] == 'Yes'){
				...
				$IdDeThi = $_GET['Id'];
	?>
	<p style="font-weight:bold;">Trình Độ <?php echo getInfoLearnEngById($IdLearning)->Name ?> > <?php echo getInfoLevelEngById($IdLevel)->Name ?></p>
...
<div style="display: block; position: fixed; top: 20px; left: 30px; width:150px; height:50px; background-color: aliceblue;">
	<p>&nbsp;* <a href="DSDeThiEnglish.php?IdLevel=<?php echo $IdLevel ?>&IdLearning=<?php echo $IdLearning ?>">Đề Thi Liên Quan</a></p>
</div>
</body>
</html>
