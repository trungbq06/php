		...
		<div class="center_content">
            ...
            <div class="prod_box_big">
				...
				<div class="center_prod_box_big">			
					...
					<ul>
						<li style="font-size:14px">Chỉ với 600.000 VNĐ học mãi mãi!						
					</ul>
					<br />
					<br />
					...
					<p>Nạp học phí qua chuyển khoản, mời bạn chuyển vào một trong những ngân hàng dưới đây của chúng tôi. Sau khi chuyển khoản bạn gửi các thông tin sau tới hoctiengnhat24h@gmail.com:</p>	
					<ul>
