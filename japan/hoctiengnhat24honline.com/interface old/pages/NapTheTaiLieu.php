			  ...
			  if($rs->error_code == '00') {				
				// Cập nhật data tại đây
				   echo  '<script>alert("Bạn đã nạp thành công '.$rs->card_amount.' vào trong tài khoản.");</script>'; //$total_results;
			           createCart($idAcc, $rs->card_amount, "TaiLieu");
                                   updateDocByIdAcc($idAcc, "Yes");
...
<div id="main_container">
	...
	<div id="main_content"> 
		...
		<div class="center_content">
			<div class="center_title_bar">Nạp Học Phí Để Tải Tài Liệu</div>
			<div class="prod_box_big">
				...
				?>
					...
					<h2>Nạp Học Phí Để Tải Tài Liệu</h2>
