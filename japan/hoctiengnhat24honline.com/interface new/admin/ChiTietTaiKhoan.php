	...
	<div style=" width:980px; margin:0 auto;">	
		...
		<caption style="font-weight:bold; font-size:16px; margin-bottom:15px;">Chi Tiết Tài Khoản</caption>
			<tr>
                ...
                <th style="font-size:14px; font-weight:bold; border:#666 1px solid; width:150px">Trạng Thái Học</th>
				<th style="font-size:14px; font-weight:bold; border:#666 1px solid; width:150px">Trạng Thái Tài Liệu</th>
				...
				<th style="font-size:14px; font-weight:bold; border:#666 1px solid">Số Tiền</th>
			...
			<tr onmouseover="this.style.backgroundColor='#ffff66';"
				...
				<td style="text-align:center;  border-right:1px #666 solid;">
					<?php 
						$statusDoc = readAtAccByIdAcc($IdAcc)->StatusDoc;	
					?>
                    <select name="statusDoc">
                    	<option value="No"<?php if($statusDoc=='No') echo 'selected' ?> >Khóa</option>
                        <option value="Yes"<?php if($statusDoc=='Yes') echo 'selected' ?> >Hoạt Động</option>
                    </select>
                    <input type="hidden" name="IdAt" value="<?php echo readAtAccByIdAcc($IdAcc)->Id; ?>" />
				</td>
				<td style="text-align:center;  border-right:1px #666 solid;">
				...
				<td style="text-align:center;  border-right:1px #666 solid;">
					<?php
                       $Money=getCartByIdAccount($IdAcc);
