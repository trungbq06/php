...
<body>
	...
	<div style=" width:780px; margin:0 auto;">	
        <form action="SearchTaiKhoan.php" method="get">
		<input type="text" name="txtSearch"/><input type="submit" value="Tìm Kiếm"/>
	</form>
		...
		<caption style="font-weight:bold; font-size:16px; margin-bottom:15px;">Danh Sách Tài Khoản</caption>
			<tr>
				...
				<th style="font-size:14px; font-weight:bold; border:#666 1px solid; padding-top:15px;">Username</th>
				<th style="font-size:14px; font-weight:bold; border:#666 1px solid">Trạng Thái Học</th>
				<th style="font-size:14px; font-weight:bold; border:#666 1px solid">Trạng Thái Tài Liệu</th>
                <th style="font-size:14px; font-weight:bold; border:#666 1px solid">Chi Tiết Tài Khoản</th>
			...
			<tr onmouseover="this.style.backgroundColor='#ffff66';"
				...
				<form action="../controller/AccountController.php" method="post" >
					...
					<td style="text-align:center;  border-right:1px #666 solid;">
						<?php
						$trangthai = readAtAccByIdAcc($item->Id)->Status;
					
						if($trangthai=="No") 
							echo '<img src="images/uncheck.png" alt="" />';
						else 
							echo '<img src="images/icon-check.png" alt="" />';
						?>
					</td>
					<td style="text-align:center;  border-right:1px #666 solid;">
						<?php
						$trangthaiDoc = readAtAccByIdAcc($item->Id)->StatusDoc;
					...
					<td style="text-align:center;  border-right:1px #666 solid;">
						<a href="ChiTietTaiKhoan.php?IdAcc=<?php echo $item->Id ?>" style="text-decoration:none; padding:15px; font-weight:600; ">Chi Tiết</a>
					</td>
					<td style="text-align:center;  border-right:1px #666 solid;">
						<p class="submit">
