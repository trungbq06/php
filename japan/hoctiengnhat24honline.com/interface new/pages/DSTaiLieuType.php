                            ...
                            <article class="col1">
                                <div class="pad_left1">
                                    ...
                                    if ((isset($_SESSION['loginAcc'])) and (isset($_SESSION['id']))) {
                                        if ($_SESSION['loginAcc'] == 'Yes') {												$active = 'No';												$active = readAtAccByIdAcc($_SESSION["id"])->StatusDoc;	
                                            ?>
                                            ...
                                            foreach ($TLHocTap as $item) {
                                                ...
                                                <table width="553" height="103" border="1">
                                                    ...
                                                    <tr>													
                                                        <td height="20"> 														<?php														if($active=='Yes'){														?>														Link Download : <a href="<?php echo $item->Url ?>"  target="_blank">Click vào đây để tải về</a>														<?php																												}else if($active=='No'){														?>														Mời Bạn Đóng Phí Để Được Tải Tài Liệu <a href="NapThe.php">Click vào đây để xem hướng dẫn</a>														<?php																												} else {														?>																				Mời Bạn Đóng Phí Để Tải Tài Liệu <a href="HocPhi.php">Click vào đây để xem hướng dẫn</a>																				<?php																												}														?>															</td>
                                                    </tr>
                                                </table>
