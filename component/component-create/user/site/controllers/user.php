 ...
 */
class AvaControllerUser extends AvaController {
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('User', 'AvaModel');
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_ava&view=userform&layout=edit', false));
    }
