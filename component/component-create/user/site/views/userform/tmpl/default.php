...
<script type="text/javascript">
    ...
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js',function() {
        ...
        js(document).ready(function(){
            js('#form-user').submit(function(event){
...
<div class="user-edit front-end-edit">
    ...
    <form id="form-user" action="<?php echo JRoute::_('index.php?option=com_ava&task=user.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
        <ul>
			...
			<div class="control-group">
				...
				<div class="fltlft" <?php if (!JFactory::getUser()->authorise('core.admin','ava')): ?> style="display:none;" <?php endif; ?> >
        ...
        <div>
            ...
            <?php echo JText::_('or'); ?>
            <a href="<?php echo JRoute::_('index.php?option=com_ava&task=userform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
