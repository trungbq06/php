 ...
 */
class AvaViewUsers extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		AvaBackendHelper::addSubmenu('users');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_AVA_TITLE_USERS'), 'users.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_ava&view=users');
	...
	protected function getSortFields()
	{
		...
		'a.school_id' => JText::_('COM_AVA_USERS_SCHOOL_ID'),
		'a.name' => JText::_('COM_AVA_USERS_NAME'),
		'a.phone_number' => JText::_('COM_AVA_USERS_PHONE_NUMBER'),
		'a.email' => JText::_('COM_AVA_USERS_EMAIL'),
		'a.address' => JText::_('COM_AVA_USERS_ADDRESS'),
		'a.job' => JText::_('COM_AVA_USERS_JOB'),
		);
	}
