...
<script type="text/javascript">
    ...
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js',function() {
        ...
        js(document).ready(function(){
            js('#form-school').submit(function(event){
...
<div class="school-edit front-end-edit">
    ...
    <form id="form-school" action="<?php echo JRoute::_('index.php?option=com_ava&task=school.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
        <ul>
			...
			<div class="control-group">
                ...
                <script type="text/javascript">
                    ...
                    jQuery('.tab-pane select').each(function(){
                       ...
                       document.getElementById("form-school").appendChild(input);
                    });
                </script>
             <?php endif; ?>
        </ul>
        ...
        <div>
            ...
            <?php echo JText::_('or'); ?>
            <a href="<?php echo JRoute::_('index.php?option=com_ava&task=schoolform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>

            <input type="hidden" name="option" value="com_ava" />
            <input type="hidden" name="task" value="schoolform.save" />
