<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-edit"></i> {$lang_form_create} {$lang_gallery}</h2>
			<div class="box-icon">
			...
			<form class="form-horizontal" action="" enctype="multipart/form-data" id="FrmCreateuser" method="post">
				<fieldset>
				  <div class="control-group">
					<label class="control-label" for="">{$lang_name} {$lang_gallery}</label>
					<div class="controls">
				  ...
				  <div class="control-group">
					<label class="control-label" for="">{$lang_link}</label>
					<div class="controls">
