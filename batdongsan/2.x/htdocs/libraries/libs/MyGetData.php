...
class MyGetData extends DataBase{
	...
	function convert_utf8($table, $col1=NULL, $col2=NULL){
		...
		$sql2 ="ALTER TABLE product_2
				DEFAULT CHARSET=utf8,
				MODIFY COLUMN code text CHARACTER SET utf8";
	}
...
public function get_select_from_table($table, $tree=1, $active=0, $parent=0, $not_id=0, $set_child=NULL){
	...
	public function get_select_from_table2($table, $type=0, $tree=1, $active=0, $parent=0, $not_id=0, $set_child=NULL){
		$result = "";
		$sql = "SELECT a.id,a.name,a.type FROM $table AS a WHERE a.active=1 AND a.parent_id=$parent AND a.type=$type";
