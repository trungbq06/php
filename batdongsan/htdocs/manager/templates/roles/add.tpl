			...
			<form class="form-horizontal" action="" id="FrmCreateuser" method="post">
				<fieldset>
				  ...
				  <div class="control-group">
					...
					<div class="controls">
					  <input class="input-xlarge " name="alias" type="text" required>
					</div>
				  </div>
				  ...
				  <div class="control-group">
					...
					<div class="controls">
					  <input class="input-xlarge " name="url" type="text" required>
					</div>
				  </div>
				  ...
				  <div class="control-group">
					...
					<div class="controls">
					  <input class="input-large" value="icon-tasks" name="icon" type="text" required>
					</div>
				  </div>
