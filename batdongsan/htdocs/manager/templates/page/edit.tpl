<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-edit"></i> {$lang_edit}</h2>
			<div class="box-icon">
			...
			<form class="form-horizontal" action="" enctype="multipart/form-data" id="FrmCreateuser" method="post">
				<fieldset>
				  ...
				  <div class="control-group">
					...
					<div class="controls">
					  <input class="input-xxlarge " name="address" type="text" required value="{$detail.address}">
					</div>
				  </div>
				  ...
				  <div class="control-group">
					...
					<div class="controls">
					  <input class="input-xxlarge " name="hotline" type="text" required value="{$detail.hotline}">
					</div>
				  </div>
				  ...
				  <div class="control-group">
					...
					<div class="controls">
					  <input class="input-xlarge " name="map" type="text" required value="{$detail.map}">
					</div>
				  </div>
