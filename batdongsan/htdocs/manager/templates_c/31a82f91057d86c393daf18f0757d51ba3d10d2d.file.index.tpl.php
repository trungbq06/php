<?php /* Smarty version Smarty-3.1.18, created on 2015-10-15 01:23:45
         compiled from "/home/tuvanxd/domains/tuvanxaydungtructuyen.vn/public_html/manager/templates/posts/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1917676254561f0021666e35-95816509%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '31a82f91057d86c393daf18f0757d51ba3d10d2d' => 
    array (
      0 => '/home/tuvanxd/domains/tuvanxaydungtructuyen.vn/public_html/manager/templates/posts/index.tpl',
      1 => 1407158390,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1917676254561f0021666e35-95816509',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_561f002171af35_43953551',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_561f002171af35_43953551')) {function content_561f002171af35_43953551($_smarty_tpl) {?><div class="row-fluid sortable">		
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-user"></i> Quản lý tin đăng</h2>
			<div class="box-icon">
...
"><?php echo $_smarty_tpl->tpl_vars['value']->value['name'];?>
					...
					<td><a href="posts?id=<?php echo $_smarty_tpl->tpl_vars['value']->value['category_detail'];?>
"><?php echo $_smarty_tpl->tpl_vars['value']->value['category'];?>
</a></td>
					<td class="center">
                         <a href="#" table="tbl_posts" value="<?php echo $_smarty_tpl->tpl_vars['value']->value['id'];?>
" class="label frm_active <?php if ($_smarty_tpl->tpl_vars['value']->value['active']==1) {?>label-success<?php } else { ?>label-warning<?php }?>" title="Click to Active/Inactive  this filed"><?php echo $_smarty_tpl->tpl_vars['value']->value['active_view'];?>
					...
					<td class="center">
						<a title="View" href="?mod=posts&site=view&id=<?php echo $_smarty_tpl->tpl_vars['value']->value['id'];?>
"><i class="icon-zoom-in"></i></a> &nbsp;&nbsp;|&nbsp;&nbsp; 
						<a title="Delete" href="#" link="?mod=helps&site=delete&table=posts&id=<?php echo $_smarty_tpl->tpl_vars['value']->value['id'];?>
