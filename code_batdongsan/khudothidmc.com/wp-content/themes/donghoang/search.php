				...
				<main class='content template-search <?php avia_layout_class( 'content' ); ?> units' <?php avia_markup_helper(array('context' => 'content'));?>>
                    ...
                    <div class='page-heading-container clearfix'>
                        <section class="search_form_field">
                            <?php
                            echo "<h4>".__('Tìm kiếm mới','avia_framework')."</h4>";
                            echo "<p>".__('Nếu bạn không hài lòng với kết quả dưới đây xin vui lòng thực hiện một tìm kiếm khác','avia_framework')."</p>";
