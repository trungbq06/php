                ...
                <span class='post-meta-infos'>
                    ...
                    if(get_post_type() !== "page")
                    {
                        if ( get_comments_number() != "0" || comments_open() )
                        {
                            ...
                            comments_popup_link(  "0 ".__('Bình Luận','avia_framework'),
                                                  "1 ".__('Bình Luận' ,'avia_framework'),
                                                  "% ".__('Bình Luận','avia_framework'),'comments-link',
                                                  "".__('Đóng Bình Luận','avia_framework'));
                            echo "</span>";
                        }
                    }
...
?>
	...
	<article class="entry entry-content-wrapper clearfix" id='search-fail'>
            <p class="entry-content" <?php avia_markup_helper(array('context' => 'entry_content')); ?>>
                <strong><?php _e('Không tìm thấy dữ liệu', 'avia_framework'); ?></strong><br/>
               <?php _e('Xin lỗi, không có bài viết nào phù hợp với tiêu chí của bạn. Xin vui lòng thử một tìm kiếm khác', 'avia_framework'); ?>
            </p>
            ...
            <section class="search_not_found">
                ...
                <ul>
                    <li><?php _e('Kiểm tra chính tả của bạn.', 'avia_framework'); ?></li>
                    <li><?php _e('Hãy thử một từ khóa tương tự, ví dụ: máy tính bảng thay vì máy tính xách tay.', 'avia_framework'); ?></li>
                    <li><?php _e('Hãy thử sử dụng nhiều hơn một từ khoá.', 'avia_framework'); ?></li>
                </ul>

                <div class='hr_invisible'></div>
                <h3 class=''><?php _e('Cảm thấy như xem một số bài viết để thay thế?', 'avia_framework'); ?></h3>
